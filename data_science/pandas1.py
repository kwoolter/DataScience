...
def df_test2():
    ...
    title = "Welcome to the finite state machine game!"
    print("*" * (len(title) + 5))
    print("* " + title + " *")
    print("*" * (len(title) + 4))
    ...
    while True:
        ...
        print(f'{current_state["Name"]} : {current_state["Description"]}')
        ...
        # If the current state has not transitions then end
        ...
        #transitions = state_transitions.loc[[current_state_id]]
        ...
        # Get the state transition details for teh selected state
